...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] nama, id, alamat, gambar, call_center;
    int jumData;
    ...
    private void getlokasi(){
        String url = "https://gisatmbca.000webhostapp.com/bca.php";
        JsonArrayRequest request = new JsonArrayRequest
                (Request.Method.GET, url, new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        call_center = new String[jumData];
                        ...
                        for (int i = 0;  i < jumData; i++) {
                            try {
                                ...
                                call_center[i] = data.getString("call_center");
                                ...
                                mMap.addMarker(new MarkerOptions()
                                        .position(latLng[i])
                                        .title(nama[i])
                                        .icon(BitmapDescriptorFactory.fromResource(R.drawable.depannn))
                                        //.icon(BitmapDescriptorFactory.fromResource(R.drawable.ter))
                                        .snippet(alamat[i]));
                                ...
                                for (int i=0;i<jumData;i++) {
                                    if (marker.getTitle().equals(nama[i])){
                                        if (MarkerD[i]){
                                            ...
                                            DetailActivity.call_center = call_center[i];
                                            ...
                                            Toast pesan = Toast.makeText(MapsActivity.this,"klik disini lagi",Toast.LENGTH_LONG);
